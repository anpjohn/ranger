...
echo
echo
read -p "Enter the IP you want to access the web gui on in quotes for openvas, scroll up if you need it (enter 0.0.0.0 in quotes if configuring later) : " ip_input
echo
echo
